...
```{r,warning=FALSE,out.width='100%',fig.height=9, fig.width=14,message=FALSE,}
...
```{r,warning=FALSE,out.width='100%',message=FALSE,echo=FALSE}
Mod1=gam(outcome~
...
```{r,warning=FALSE,out.width='100%',fig.height=9, fig.width=14,message=FALSE,}
knitr::include_graphics("model1_1.png")
```
